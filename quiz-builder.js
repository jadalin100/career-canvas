...
*{box-sizing:border-box}body{margin:0;background:#eef1f7;color:#071a38;font:16px/1.5 Arial,sans-serif}.wrap{width:min(760px,calc(100% - 32px));margin:40px auto;background:#fff;box-shadow:0 18px 45px rgba(9,36,84,.1)}header{padding:18px 24px;color:#fff;background:#092454;font-weight:800}main{padding:36px}h1{margin:0;color:#061a3a;font-size:clamp(34px,7vw,56px);line-height:1}.intro{color:#66758e}.count{color:#2563eb;font-size:12px;font-weight:800;text-transform:uppercase}.question{margin:28px 0 18px;font-size:26px;font-weight:800}.options{display:grid;gap:10px}.options button{padding:14px;text-align:left;color:#092454;background:#fff;border:1px solid rgba(9,36,84,.16);font:inherit;cursor:pointer}.options button.selected{border-color:#2563eb;box-shadow:inset 4px 0 #2563eb}.next{margin-top:22px;padding:13px 18px;color:#061a3a;background:#ffd43b;border:0;font-weight:800;cursor:pointer}.next:disabled{opacity:.45}.result{padding:24px;color:#fff;background:#092454}.result strong{color:#ffd43b;font-size:34px}@media(max-width:600px){.wrap{width:100%;margin:0;min-height:100vh}main{padding:28px 20px}}
